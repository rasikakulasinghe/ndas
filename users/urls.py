...
urlpatterns = [
    ...
    # URLs for password reset (rate-limited to prevent abuse)
    path('reset_password/', views.RateLimitedPasswordResetView.as_view(template_name='users/password_reset.html', form_class=UserPasswordResetForm), name='reset-password'),
